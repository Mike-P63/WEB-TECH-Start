...
$job = [
    [
        'job_title' => 'Junior-Тестировщик',
        'job_date_start'=> '2018',
        'job_date_end'=> '2020',
        'description' => 'Опыт работы в области тестирования от 2-х лет;
Опыт тестирования програмных продуктов в крупной компании;
...
Знание HTML, CSS/SCSS, JavaScript;
Опыт работы с Celery, RabbitMQ или фоновыми задачами в aiohttp, fastapi;',
    ],
      [
        'job_title' => 'Middle-Тестировщик',
          'job_date_start'=> '2021',
        'job_date_end'=> 'по НАСТОЯЩЕЕ время',
        'description' => 'Тестирование програмных продуктов, ручное тестирование
        ● тест-дизайн
        ● чек-листы
        ● тест-кейсы
      ...
      <div class="w3-twothird">
        ...
        <?php for ($i=0;$i<count($job);$i++):?>
           <div class="w3-container">
            ...
            <?php if ($job[$i]['job_date_end']=='по НАСТОЯЩЕЕ время'):?>
            <span
